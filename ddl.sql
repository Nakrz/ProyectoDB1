...
CREATE TABLE jefe (
    ...
    id_puesto INT(11),
    CONSTRAINT FK_id_oficina_jefe FOREIGN KEY (id_oficina) REFERENCES oficina(id_oficina),
    CONSTRAINT FK_id_puesto_jefe FOREIGN KEY (id_puesto) REFERENCES puesto(id_puesto)
);
...
CREATE TABLE empleado (
    ...
    CONSTRAINT FK_id_jefe_empleado FOREIGN KEY (id_jefe) REFERENCES jefe(id_jefe),
